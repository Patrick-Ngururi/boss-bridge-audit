...
install :; forge install foundry-rs/forge-std --commit && forge install openzeppelin/openzeppelin-contracts@v5.0.2 --commit && forge install openzeppelin/openzeppelin-contracts-upgradeable@v5.0.2 --commit
